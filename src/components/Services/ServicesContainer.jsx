...
import observerLeftSlide from '../../hooks/observerLeftSlide'
...
useEffect(()=>{
  ...
  return (
    <div className=' container w-[76%] h-fit mx-auto my-auto border-4 border-[#0dcdbd]  dark:bg-gray-900 rounded-2xl mb-8 shadow-lg'>
        ...
        <span class="hide bg-gray-100 text-black mt-6 inline-flex items-center px-4 gap-x-4 py-0.5 rounded  dark:bg-gray-900 dark:text-white w-fit mx-auto border-2 border-[#0dcdbd]">
           <CgWebsite></CgWebsite>
              Website development
        </span>
        <span class="hide bg-gray-100 text-black mt-6 inline-flex items-center px-4 gap-x-4 py-0.5 rounded  dark:bg-gray-900 dark:text-white w-fit mx-auto border-2 border-[#0dcdbd]">
